...
export default function EditPersonalProject({ history }) {
  ...
  useEffect(() => {
    const getProjects = async () => {
      try {
        const resp = await fetchData(`personal_projects/${id}`)
  ...
  return (
    <Container>
      {showAdminBoard ? (
        <>
          <Headline>Edit Personal Project</Headline>
